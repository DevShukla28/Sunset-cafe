          ...
          <div className="blog5-wrapper">
            <div className="bolg5Container">
              <div className="blog5-header">
                <h1>
                  {" "}
                  #5 Bites of Bliss: The Sweet <br /> Symphony of Pastries at
                  Café <br /> Sunset
                </h1>
              </div>
              ...
              <div className="blog5Para">
                <p>
                  ...
                  where every pastry is a delightful note in the grand
                  composition of flavors. Join us on a journey through our
                  delectable selection, where each bite is a moment of bliss
              ...
              <div className="blog5-3rdP">
                <img src={"./Images/Ellipse 205.png"} alt="" />
              ...
              <div className="blog5-3rdP">
                ...
                <p>
                  ...
                  our baristas <br /> will guide you to the ideal culinary duet
                  to enhance your pastry experience.
                </p>
              </div>
              ...
              <div className="blog5last-bitesblis-header">
                ...
                <p>
                  ...
                  pastries—a crescendo of flavors, textures, and <br /> moments
                  that elevate the simple act of biting into a blissful
                  indulgence. <br />
                  Join us for a pastry sojourn at Café Sunset, where every bite
                  is a note in the melody of sweetness, and the art <br /> of
                  pastry becomes a delightful journey into the heart of
                  indulgence.
                </p>
              </div>
            </div>
