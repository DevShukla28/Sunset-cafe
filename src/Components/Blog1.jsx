        ...
        <Layout page="Menu">
          <div className="page1Blog-wrapper">
            <div className="page1Blog-container">
              ...
              <hr
                className="blog1sthr-1stsec"
                style={{ borderColor: "#D16E43", margin: "2rem 0 0 25rem" }}
              />
                  ...
                  <div className="blog1-sec2Left">
                    <div className="blog1sec2-header">
                      ...
                      <div className="blog1-mangoTango-div">
                        <img src={"./Images/Ellipse 53.png"} alt="" />
                        <p>
                          ...
                          palate. Topped with grilled chicken <br /> for a
                          protein boost and garnished <br />
                ...
                <div className="slider-container blog1caraosel-mob">
                  <Slider {...mobslidersettings}>
                    <div className="mobview-header">
                      ...
                      <img src={"./Images/Ellipse 54.png"} alt="" />
                      <p>
                        Dive into a refreshing symphony of flavors with our
                        Mango Tango Fusion Salad. Crisp mixed greens, juicy
                        mango slices, and cherry tomatoes are tossed with a
                        zesty mango-lime dressing, creating a burst of tropical
                        goodness on your palate. Topped with grilled chicken for
                        a protein boost and garnished with crunchy almond
                        slivers
                      </p>
                    </div>
                    <div className="mobview-header">
                      ...
                      <img src={"./Images/Ellipse 54.png"} alt="" />
                      <p>
                        Immerse yourself in the bold and aromatic notes of our
                        Spiced Infusion Sea Bass. Fresh fillets of sea bass are
                        delicately seasoned with a blend of Indian spices,
                        including cumin, coriander, and turmeric, then seared to
                        perfection. Served on a bed of saffron-infused basmati
                        rice and accompanied by a side of mint-cilantro chutney,
                        this dish is a celebration of coastal flavors with a
                        touch of Indian flair.
                      </p>
                    </div>
                  </Slider>
                </div>
              ...
              <div className="blog1sec3">
                ...
                <li>
                  Sunset Insider Club: Unlock premium benefits by becoming a
                  part of our exclusive membership program.
                </li>
                <h5>
                  Indulge in the Extraordinary. Reserve Your Seat for an
                  Exclusive Culinary Soiree at Café Sunset.
                </h5>
              </div>

              <hr
                style={{ borderColor: "#D16E43", margin: "0 35rem 2rem 0" }}
              />
              ...
              <div className="blog1sec4">
                ...
                <li>
                  ...
                  dining experience featuring a specially crafted menu. Limited
                  to a select few connoisseurs.
                </li>
              </div>

              <hr
                className="blob1st-lastbottomhr"
                style={{ borderColor: "#D16E43", margin: "1.5rem 0 2rem 0" }}
              />

              <div className="blog1sec5Last">
                <h3>WHERE WE’VE BEEN FEATURED</h3>
                <div className="liveEvent-img">
                  <img src={"./Images/Rectangle 361.png"} alt="" />
                  <img src={"./Images/Rectangle 362.png"} alt="" />
                  <img src={"./Images/Rectangle 363.png"} alt="" />
                  <img src={"./Images/Rectangle 364.png"} alt="" />
                </div>
              </div>
